...
#define HYGIENE_LEVEL_CLEAN 450
#define HYGIENE_LEVEL_NORMAL 400
#define HYGIENE_LEVEL_DIRTY 75
#define HYGIENE_FACTOR_LOWEST 0.07
#define HYGIENE_FACTOR 0.09
#define HYGIENE_FACTOR_HIGHEST 0.1

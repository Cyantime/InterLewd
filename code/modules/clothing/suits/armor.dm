...
/obj/item/clothing/suit/armor/laserproof/handle_shield(mob/living/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, var/attack_text = "the attack")
...
/obj/item/clothing/suit/armor/reactive/handle_shield(mob/living/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, var/attack_text = "the attack")
	if(prob(50))
...
//Modular plate carriers, ported from Baystation
...
/obj/item/clothing/suit/armor/pcarrier/medium/security
	starting_accessories = list(/obj/item/clothing/accessory/armorplate/medium, /obj/item/clothing/accessory/storage/pouches)
/obj/item/clothing/suit/armor/pcarrier/medium/security/initialize()
	if(prob(90))
		starting_accessories += pick(subtypesof(/obj/item/clothing/accessory/armor/tag/lewd))
	. = ..()

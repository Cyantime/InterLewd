...
/mob/living/carbon/human/Topic(href, href_list)
	...
	if(href_list["interaction"])
		...
		var/hasvagina = (H.vag && H.species.genitals && H.species.name != "Unathi" && H.species.name != "Stok")
		var/hasvagina_p = (P.vag && P.species.genitals && P.species.name != "Unathi" && P.species.name != "Stok")
		...
		if (href_list["interaction"] == "bow")
			...
			if(((Adjacent(P) && !istype(P.loc, /obj/structure/closet)) || (H.loc == P.loc)) && mouthfree && hasvagina_p)
				H.fuck(H, P, "vaglick")

		else if (href_list["interaction"] == "asslick")
			if(((Adjacent(P) && !istype(P.loc, /obj/structure/closet)) || (H.loc == P.loc)) && mouthfree && hasanus_p)
				H.fuck(H, P, "asslick")

		else if (href_list["interaction"] == "fingering")
			if(((Adjacent(P) && !istype(P.loc, /obj/structure/closet)) || (H.loc == P.loc)) && hashands && hasvagina_p)
				H.fuck(H, P, "fingering")
				
		else if (href_list["interaction"] == "assfinger")
			if(((Adjacent(P) && !istype(P.loc, /obj/structure/closet)) || (H.loc == P.loc)) && hasanus_p && hashands)
				H.fuck(H, P, "assfinger")
			...
			if(((Adjacent(P) && !istype(P.loc, /obj/structure/closet)) || (H.loc == P.loc)) && hashands && haspenis_p)
				H.fuck(H, P, "handjob")
				
		else if (href_list["interaction"] == "suckballs")
			if(((Adjacent(P) && !istype(P.loc, /obj/structure/closet)) || (H.loc == P.loc)) && isnude_p && mouthfree && haspenis_p)
				H.fuck(H, P, "suckballs")

		else if (href_list["interaction"] == "anal")
			if (((Adjacent(P) && !istype(P.loc, /obj/structure/closet)) || (H.loc == P.loc)) && isnude_p && isnude && haspenis && hasanus_p)
				if (H.erpcooldown == 0)
					if (H.potenzia > 0)
						H.fuck(H, P, "anal")
				else
			...
			if (((Adjacent(P) && !istype(P.loc, /obj/structure/closet)) || (H.loc == P.loc)) && isnude && mouthfree_p && haspenis)
				if (H.erpcooldown == 0)
					if (H.potenzia > 0)
						H.fuck(H, P, "oral")
				else
		...
		else if (href_list["interaction"] == "ride")
			...
			if (H.loc == P.loc && isnude && isnude_p && hasvagina && hasvagina_p)
				H.fuck(H, P, "scissor")
				
		else if (href_list["interaction"] == "titsuck")
			if (((Adjacent(P))))
				H.fuck(H, P, "titsuck")
				
		else if (href_list["interaction"] == "titfuck")
			if (((Adjacent(P) && !istype(P.loc, /obj/structure/closet)) || (H.loc == P.loc)) && isnude && mouthfree_p && haspenis)
				H.fuck(H, P, "titfuck")
				
		else if (href_list["interaction"] == "titfucksub")
			if (((Adjacent(P) && !istype(P.loc, /obj/structure/closet)) || (H.loc == P.loc)) && isnude_p && mouthfree && haspenis_p)
				H.fuck(H, P, "titfucksub")
...
/mob/living/carbon/human/proc/has_penis()
	if(dong && potenzia > -1 && species.genitals && !mutilated_genitals)
		return 1
	else return 0
